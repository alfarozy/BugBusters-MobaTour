...
@section('content')
    <div id="home" class="relative overflow-hidden bg-primary pt-[120px] md:pt-[130px] lg:pt-[190px]"
        style="height: 80vh">
        <div class="container">
            <div class="-mx-4 flex flex-wrap items-center">
                ...
                <div class="w-full md:w-1/2 px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <p class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                            Platform penyedia jadwal turnamen online
                        </p>
                        <ul class="mb-10 flex flex-wrap items-center justify-center gap-5">
                            <li>
                                <a href="{{ route('register') }}" target="_blank"
                                    class="flex items-center gap-4 rounded-md bg-white px-6 py-[14px] text-base font-medium text-dark transition duration-300 ease-in-out hover:bg-white hover:text-dark">
                                    Daftar Sekarang
                                </a>
                            </li>
                        </ul>
                ...
                <div class="w-full md:w-1/2 px-4">
                    ...
                    <img src="/image/hero-banner.svg" alt="Your Alt Text" class="mx-auto max-w-full" />
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
                        <div
                            ...
                            <span
                                class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Kami telah menyederhanakan proses registrasi untuk memastikan bahwa Anda dapat fokus pada
                            persiapan strategi dan pertarungan Anda.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            Jadwal Turnamen Fleksibel
                        </h4>
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Bersama MOBA Tourney, Anda dapat mengakses jadwal turnamen yang fleksibel sesuai dengan waktu
                            luang Anda.
                        </p>
                    </div>
                </div>
