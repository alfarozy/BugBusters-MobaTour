...
@section('content')
    <div class="uk-container uk-flex uk-flex-center uk-flex-middle uk-height-viewport">
        ...
        <div class="uk-card uk-card-default uk-card-body uk-width-1-2@m uk-width-1-3@l">
            <!-- Logo -->
            <img class="uk-margin-bottom logo uk-align-center " src="/image/logo.svg" alt="Logo">
            ...
            <form class="uk-form-stacked" method="POST" action="{{ route('login') }}">
                ...
                <div class="uk-align-right">
                    <a href="{{ route('forgotpassword') }}" class="uk-link-muted">Lupa Password ?</a>
                </div>
                ...
                <div class="uk-margin">
                    <a href="{{ route('login.google') }}"
                        class="uk-button  uk-border-rounded uk-button  uk-button-default uk-width-1-1 uk-border-rounded">
...
uk-text-center" uk-grid>
                    <div>
                        <a href="{{ route('register') }}" class="uk-link-muted">Register sekarang</a>
                    </div>
                </div>
            </form>
        </div>
